...
div.innerHTML ='<h1>Niveau de vulnérabilité des localités   </h1>';
return div;
}
maptitle.addTo(map);
...
var north = L.control({position: "topleft"});
	north.onAdd = function(map) {
		var div = L.DomUtil.create("div", "info-legend");
			div.innerHTML = '<img src="theme/static/images/compass.png" style="width:30px;">';
		return div;
		}
north.addTo(map);
...
var localites = $.getJSON("doc/localites.geojson",function(data2)
{
	...
	onEachFeature : function(feature, layer ) {layer.bindPopup('<b><u>Nom de la localité</u></b><br>' + feature.properties.a_quartier +'<br>Niveau de Vulnérabilité : '+ feature.properties.vulnerabil+
	 '<br><strong> Diagnostic détaillé : </strong> <a href="'+ feature.properties.lien_test +'" style="text-transform: capitalize;">'+ feature.properties.a_quartier +'</a>')}
});
